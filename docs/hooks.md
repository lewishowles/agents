...
The registered-hook table and detailed hook guidance on this page describe Claude Code. The registered hooks come from the Claude hook manifests in `src/hooks/claude/`. Codex discovers skills from their descriptions and has a separate hook system. HCOM wiring covers both runtimes, as described below.
