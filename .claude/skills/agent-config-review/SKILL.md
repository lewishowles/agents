...
3. Entry points: `scripts/validate.sh` and `scripts/sync.sh`. Don't run `project-checks-repo-context` against this repo. It defaults to target projects, not Configuration/Agents itself.
